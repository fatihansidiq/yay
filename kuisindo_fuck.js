  ...
  $.dlxQuiz = function ( element, options ) {
    var plugin = this,
	   ...
	   * b nilai 60-79
         ...
         * f nilai 0-19
         */
          a: "Nilai Sempurna! Anda lulus ujian Matematika (armyindonesia)",
          b: "Hampir! Anda lulus ujian Matematika(armyindonesia)",
          c: "Anda tidak lulus ujian Matematika(armyindonesia)",
          d: "Anda tidak lulus ujian Matematika(armyindonesia)",
          f: "Anda tidak lulus ujian Matematika(armyindonesia)",
          g: "Selamat! Anda lulus ujian Matematika(armyindonesia)"
        },
